...
export default class Contentful {
  ...
  static async updateStreamerByTwitchUsername(username, data) {
    const query = `{
    ...
    await this.updateStreamerById(id, data);
  }
  static async updateStreamerById(id, data) {
