...
export default class Contentful {
  ...
  static async updateStreamerByTwitchUsername(
    ...
    await this.updateStreamerById(id, twitchData, streamData, vodData);
  }
  static async updateStreamerById(id, twitchData, streamData, vodData) {
    ...
    await client
      ...
      .then((entry) => {
        var patch = [
          {
            op: entry.fields.twitchData ? "replace" : "add",
            path: "/fields/twitchData/en-US",
            value: twitchData || {},
          },
          {
            op: entry.fields.streamData ? "replace" : "add",
            path: "/fields/streamData/en-US",
            value: streamData || {},
          },
          {
            op: entry.fields.vodData ? "replace" : "add",
